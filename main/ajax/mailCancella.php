<?
	...
	var_dump($checkStart > $today && $checkStart < $twoMonthsNow);
...
EOT;
			...
			$mail->Subject    =  $_SESSION["username"]." cancella l'evento ".$evento["title"];
			//$mail->SetFrom($email, $nome);
			//$mail->AddReplyTo($email, $nome);
			//$mail->Subject    = $oggetto;
			$mail->AltBody    = "To view the message, please use an HTML compatible email viewer!"; // optional, comment out and test			
			$mail->MsgHTML(	"Tipo Evento: ".$evento["tipo"].
			"<br>Data: ".$evento["start"]." - " .$evento["end"].
			"<br> Location : ".$evento["location"].
			"<br> Partecipanti : ".$evento["partecipanti"]);
