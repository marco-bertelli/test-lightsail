    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a id ='logouter'   href="javascript:;"><i class="fa fa-key"></i> Log Out</a></li>
                <?php if ($_SESSION["role"]=="admin" ||$_SESSION["role"]=="commerciale" ) {?>  
                    <li><a id ='role'   href="javascript:routine('utenti', 'stampa','<?=$_SESSION["id_utente"]?>');"><i class="fa fa-users"></i>Profilo</a></li>
                <?}?>
            </ul>
        </li>
...
<!--main content start-->
    <section id="main-content">
        <section class="wrapper">
            <div id="modale"></div>
            <div id="module">
			 <?php require_once("views/homesearch.php");?> 
			</div>
       <!-- page end-->
        </section>
    </section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span name="lbl">Logout</span></h4>
            </div>
            <div class="modal-body">
			Siete sicuri di voler effettuare il logout ?<br>
			Così facendo verranno persi tutti i cambiamenti non salvati.<br><br>
                 <a href="index.php?logout=1" id="LogYES"  class="btn btn-warning btn-sm "><span name="lbl" caption="Edit">Si</span></a>
...
<!--script src="js_sw/demone.js"></script-->
 <script>
    ...
    $(document).on({       
         ajaxStart: function() { 
             //console.log(localStorage.testAjax);
             if(localStorage.testAjax === "true") {
                // alert("ajax si");
