...
<form id="edit-event"  role="form" action="javascript:;" method="POST" enctype="multipart/form-data" data-id='<?=$item["id"]?>' >
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <div id="evento-2" class="tab-pane active ">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id ='e_title' name="title" value="<?=$item['title']?>"/>
                        </div>
                        <div class="form-group col-md-6" style='padding-left:0'>
                            <label class="flabel" for='tipo'>Tipo Evento:</label>

                            <select type="text" id ='tipo' name="tipo" class="form-control">
                                <option value="<?=$item['tipo']?>" selected="selected"><?=$item['tipo']?></option>
                        ...
                        <!--div class="form-group">
                                   ...
                                   <input class="form-control" type="text" id ='location' name="location" value="<?=$item['location']?>"/>
                                </div-->
                        <div class="form-group col-md-6" style='padding-right:0'>
                            <label class="flabel" for='e_title'>Location:</label>

                            <select type="text" id ='location' name="location" class="form-control">
                                <option value="<?=$item['location']?>" selected="selected"><?=$item['location']?></option>
                        ...
                        <div class="form-group col-md-4" style='padding-left:0'>
                            <label class="flabel" for='citta'>Citta: </label>
                            <input class="form-control" type="text" id ='citta' name="citta" value="<?=$item['citta']?>"/>
                        </div>
                        <div class="form-group col-md-4" style='padding-left:0'>
                            <label class="flabel" >Numero d'Ordine: </label>
                            <input class="form-control" type="text" id ='numero' name="numero" value="<?=$item['numero']?>"/>
                        </div>
                        <div class="form-group col-md-4" style='padding-right:0'>
                            <label class="flabel" for='e_title'>N Partecipanti: </label>
                            <input class="form-control" type="text" id ='partecipanti' name="partecipanti" value="<?=$item['partecipanti']?>"/>
                        </div>
                        <div class="form-group">
                            <label class="flabel" for='e_title'>Note: </label>
                            <input class="form-control" type="text" id ='e_note' name="note" value="<?=$item['note']?>"/>
                        </div>

                    </div>
                </div>

                <input id="piked_cliente"       name="id_cliente"    type="hidden" value="<?=$item["id_cliente"]?>">
                <div id="cliente-2" class="tab-pane ">

                    <div style="padding-bottom:50px;" class="form-group">

                        <a id="cliente" data-pr="<?=$item["id_pr"]?>" href="javascript:;" class="btn btn-info pick_list pull-left"  ><i class="fa fa-refresh">&nbsp</i>Assegna Cliente</a>
                ...
                <div id="gestione-2" class="tab-pane ">
                    ...
                    <input id="piked_pr"   name="id_pr"  type="hidden" value="<?=$item['id_pr']?>"  >
                    <div class='row'>
                        <div class="form-group col-md-5">
                            <label class="flabel" for='tipo'>Direttore:</label>

                            <select type="text" id ='direttore' name="direttore" class="form-control">
                                <option value="<?=$item['direttore']?>" selected="selected"><?=$item['direttore']?></option>
                        ...
                        <div style="padding-left:0px;" class="form-group col-sm-5">
                            ...
                            <input id="pr_name" type="text"  class="form-control" name="pr_name"   value="<?=$item['pr_name']?>"  />
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="dp1" name="start" size="16" type="text" value="<?=$item["inizio"]?>"  class="form_datetime form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-2">Data Fine:</label>
                        <div class="col-md-6">
                            <input id="dp2" name="end" size="16" type="text" value="<?=$item["fine"]?>"  class="form_datetime form-control">
                        </div>
                    </div>
                    <div class="form-group col-md-6" style="padding-left:0">
                        <label class="flabel">Caparra: </label>
                        <input class="form-control" type="text" id="caparra" name="caparra" value="<?=$item["caparra"]?>">
                    </div>
                    ...
                    <div class="form-group col-md-6" style="padding-right:0">
                        ...
                        <select type="text" id ='e_text_col' name="textColor" class="form-control">
                            <option value="white" <? if ($item['colore'] == "white") echo "selected='selected'" ?> >Bianco</option>
                            <option value="red"   <? if ($item['colore'] == "red") echo "selected='selected'" ?> >Rosso</option>
                    ...
                    <!--div class="form-group clk_adm">                            
                                    <label class="flabel" for='e_back_col'>Colore di Sfondo:</label>
                                     <select type="text" id ='e_back_col' name="color" class="form-control">
                                                ...
                                                <option value="#f37054"     <? if ($item['sfondo'] == "#f37054") echo "selected='selected'" ?> >Rosso</option>
                                                <option value="#A9D86E" <? if ($item['sfondo'] == "#A9D86E") echo "selected='selected'" ?> >Verde</option>
                                                <option value="#a1a1a1" <? if ($item['sfondo'] == "#a1a1a1") echo "selected='selected'" ?> >Grigio</option>
                                                <option value="#232ccb" <? if ($item['sfondo'] == "#232ccb") echo "selected='selected'" ?> >Blu</option>
                                                <option value="#1FB5AD" <? if ($item['sfondo'] == "#1FB5AD") echo "selected='selected'" ?> >Azzurro</option>
                                                <option value="#a48ad4" <? if ($item['sfondo'] == "#a48ad4") echo "selected='selected'" ?> >Fucsia</option>
                                                <option value="#FCB322" <? if ($item['sfondo'] == "#FCB322") echo "selected='selected'" ?> >Arancio</option>
                                    </select>                                  
                                </div-->
                    <div class="m-bot20">
                        Opziona
                        <input id="btnOpzionato" type="checkbox"  data-on="success" data-off="warning">
                        <input id="opzionato" name="opzionato" type="hidden" value="<?=$item['opzionato']?>">
                    </div>
                    <div class="m-bot20 pull-right" style='margin-top:-50px;'>
                        Conferma pr
                        <input id="btnInviato" type="checkbox"  data-on="success" data-off="warning" <? if($item['opzionato'] !='true') echo "disabled" ?>>
                        <input id="inviato" name="inviato" type="hidden" value="<?=$item['inviato']?>">
                    </div>
                    <div class="m-bot20 pull-right" style='margin-top:0px;'>
                        Conferma
                        <input id="btnconfermato" type="checkbox"  data-on="success" data-off="warning">
                        <input id="confermato" name="confermato" type="hidden" value="<?=$item['confermato']?>">
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        //var data1= new Date("<?=$item['inizio']?>Z");
        ...
        /*moment(data1).format('dd-mm-yyyy hh:ii');
         ...
         var data2= new Date("<?=$item['fine']?>Z")
        ...
        $("#edit-event").submit(function (e){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    //fixsalva $('#calendar').fullCalendar( 'refetchEvents' );
